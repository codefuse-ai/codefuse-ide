...
import type { IAIModelServiceProxy } from "../common";
import { AIModelServicePath, ModelSettingId } from "../common";
import type { IClientApp, PreferenceSchema } from "@opensumi/ide-core-browser";
import type { MaybePromise } from "@opensumi/ide-core-common";
import type { OutputChannel } from "@opensumi/ide-output/lib/browser/output.channel";
import type { ISettingRegistry } from "@opensumi/ide-preferences";
...
export class AIModelContribution
  implements PreferenceContribution, SettingContribution, ClientAppContribution
{
